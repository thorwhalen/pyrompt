...
def cmd_new(args):
    ...
    path = create_project_structure(
        args.name, base_path=args.path, include_examples=not args.no_examples
    )
...
def main():
    ...
    parser.add_argument("--path", help="Base path for collections (overrides default)")
    ...
    new_parser.add_argument(
        "--no-examples", action="store_true", help="Do not include example prompts"
    )
    ...
    list_parser.add_argument(
        "--templates", action="store_true", help="List templates instead of prompts"
    )
    ...
    show_parser.add_argument(
        "--templates", action="store_true", help="Show from templates"
    )
    ...
    add_parser.add_argument(
        "content", nargs="?", default="-", help="Prompt content (use - for stdin)"
    )
    add_parser.add_argument("--file", help="Read from file")
    add_parser.add_argument("--templates", action="store_true", help="Add to templates")
